...
void AES_encrypt(const AES_ctx* context, const uint8_t* input, uint8_t* output, size_t len); 
void AES_decrypt(const AES_ctx* context, const uint8_t* input, uint8_t* output, size_t len); 
